...
const reviews = [
...

    {
        ...
        name: "Magicard",
        date: "March 2023",
        img: "images/magicard.png",
        text:
            "A spring boot application meant to allow players to manage cards from a database.",
        project: "Group Spring Project",
        sLink: 'https://github.com/NuzziVF/card-manager.git',
        vLink: 'https://github.com/NuzziVF/card-manager.git',
    },
